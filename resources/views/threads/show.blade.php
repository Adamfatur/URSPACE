                    ...
                    <div class="d-flex gap-3 align-items-center">
                        <div class="rounded-circle bg-secondary d-flex justify-content-center align-items-center"
                            ...
                            @if($thread->user->avatar)
                                <img src="{{ $thread->user->avatar }}" alt="User" class="w-100 h-100 object-fit-cover">
                            @else
                                <span class="material-icons text-white fs-4">person</span>
                            @endif
                        </div>
                        <div>
                            <div class="fw-bold">
                    ...
                    <form id="mainReplyForm">
                        <div class="d-flex gap-3">
                            <div class="rounded-circle bg-secondary d-flex justify-content-center align-items-center flex-shrink-0"
                                ...
                                @if(auth()->user()->avatar)
                                    <img src="{{ auth()->user()->avatar }}" alt="Me" class="w-100 h-100 object-fit-cover">
                                @else
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-3">
                            @if($thread->space->owner->avatar)
                                <img src="{{ $thread->space->owner->avatar }}" class="rounded-circle object-fit-cover"
                                    style="width: 32px; height: 32px;">
                            @else
                                <div class="bg-sage-100 text-sage-600 rounded-circle d-flex align-items-center justify-content-center fw-bold small"
                                    style="width: 32px; height: 32px;">
                                    {{ substr($thread->space->owner->name, 0, 1) }}
                                </div>
                            @endif
