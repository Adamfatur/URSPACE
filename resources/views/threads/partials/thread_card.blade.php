                            ...
                            <div class="d-flex gap-2 align-items-start mb-2">
                                <div class="flex-shrink-0">
                                    <div class="rounded-circle bg-white shadow-sm d-flex align-items-center justify-content-center"
                                        ...
                                        @if($thread->pinnedPost->user->avatar)
                                            <img src="{{ $thread->pinnedPost->user->avatar }}" class="w-100 h-100 object-fit-cover">
                                        @else
                                            <span class="material-icons text-muted" style="font-size: 14px;">person</span>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="rounded-circle bg-white shadow-sm d-flex align-items-center justify-content-center"
                                            ...
                                            @if($preview->user->avatar)
                                                <img src="{{ $preview->user->avatar }}" class="w-100 h-100 object-fit-cover">
                                            @else
                                                <span class="material-icons text-muted" style="font-size: 14px;">person</span>
                                            @endif
                                        </div>
