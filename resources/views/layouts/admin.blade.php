            ...
            <div class="d-flex justify-content-between align-items-center mb-5 gap-3">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="bg-white rounded-pill px-3 py-2 shadow-sm d-flex align-items-center gap-2 border">
                        @if(auth()->user()->avatar)
                            <img src="{{ auth()->user()->avatar }}" class="rounded-circle" width="32" height="32"
                                style="object-fit: cover;">
                        @else
                            <div class="bg-sage-100 text-sage-600 rounded-circle d-flex align-items-center justify-content-center fw-bold"
