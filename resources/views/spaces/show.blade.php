                                            ...
                                            <div class="d-flex align-items-center justify-content-between p-2 bg-white rounded-3 shadow-sm">
                                                <div class="d-flex align-items-center gap-2">
                                                    @if($request->user->avatar)
                                                        <img src="{{ $request->user->avatar }}" class="rounded-circle"
                                                            style="width: 32px; height: 32px; object-fit: cover;">
                                                    @else
                                                        <div class="bg-light text-muted rounded-circle d-flex align-items-center justify-content-center fw-bold small"
                                    ...
                                    <div class="list-group-item border-0 px-4 py-3 d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-sm rounded-circle">
                                                @if($member->avatar)
                                                    <img src="{{ $member->avatar }}" class="w-100 h-100 object-fit-cover rounded-circle">
                                                @else
                                                    <div class="avatar-placeholder bg-sage-100 text-sage-600 fw-bold small">
                        ...
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex align-items-center gap-2">
                                @if($space->owner->avatar)
                                    <img src="{{ $space->owner->avatar }}" class="rounded-circle object-fit-cover"
                                        style="width: 32px; height: 32px;">
                                @else
                                    <div class="bg-sage-100 text-sage-600 rounded-circle d-flex align-items-center justify-content-center fw-bold small"
                                        style="width: 32px; height: 32px;">
                            ...
                            @foreach($space->members->where('pivot.role', 'admin')->where('id', '!=', $space->owner_id)->take(3) as $admin)
                                <div class="d-flex align-items-center gap-2">
                                    @if($admin->avatar)
                                        <img src="{{ $admin->avatar }}" class="rounded-circle object-fit-cover"
                                            style="width: 32px; height: 32px;">
                                    @else
                                        <div class="bg-light text-muted rounded-circle d-flex align-items-center justify-content-center fw-bold small"
                                            style="width: 32px; height: 32px;">
