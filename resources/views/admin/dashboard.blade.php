                    ...
                    <div class="list-group list-group-flush">
                        @foreach($recentUsers as $user)
                            <div class="list-group-item border-0 px-4 py-3 d-flex align-items-center gap-3">
                                @if($user->avatar)
                                    <img src="{{ $user->avatar }}" class="rounded-circle object-fit-cover" width="40" height="40">
                                @else
                                    <div class="rounded-circle bg-sage-100 text-sage-600 d-flex align-items-center justify-content-center fw-bold small" 
                                        ...
                                        <td class="px-4">
                                            <div class="d-flex align-items-center gap-2">
                                                @if($thread->user->avatar)
                                                    <img src="{{ $thread->user->avatar }}" class="rounded-circle" width="24" height="24">
                                                @else
                                                     <span class="material-icons text-sage-400 small">account_circle</span>
                                                @endif
